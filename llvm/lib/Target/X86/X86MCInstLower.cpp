...
void X86AsmPrinter::emitInstruction(const MachineInstr *MI) {
  ...
  case X86::M5_MARKER: {
    ...
    OutStreamer->AddComment(StringRef("marker instruction bytes start"));
    OutStreamer->emitBytes(StringRef("\x0F\x04"));
    OutStreamer->emitInt16(0x5A);
    OutStreamer->AddComment(StringRef("marker instruction bytes end"));
    return;
  }
  case X86::EH_RETURN:
  case X86::EH_RETURN64: {
